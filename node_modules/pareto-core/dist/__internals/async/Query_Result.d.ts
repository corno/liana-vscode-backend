...
export interface Query_Result<Output, Error> {
    __query_result: null;
    transform_result<New_Output>(transformer: _pi.Transformer<Output, New_Output>): Query_Result<New_Output, Error>;
    query_without_error_transformation<New_Output>(query: Queryer<New_Output, Error, Output>): Query_Result<New_Output, Error>;
    refine_without_error_transformation<New_Output>(callback: ($: Output, abort: _pi.Abort<Error>) => New_Output): Query_Result<New_Output, Error>;
